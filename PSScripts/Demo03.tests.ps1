...
# describes the function Get-Fun
Describe 'Get-Fun' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Get-Fun } | Should Not Throw
    }
    It 'does something' {
      # call function Get-Fun and pipe the result to an assertion
      # Example:
      # Get-Fun | Should Be 'Expected Output'
      # Hint: 
