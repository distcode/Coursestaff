...
function Install-distAzPSModules {
    #
...
Start-Job -ScriptBlock { Install-distPS7 }
Start-Job -ScriptBlock { Install-distAzCLI }
Start-Job -ScriptBlock { Install-distAzPSModules }
Start-Job -ScriptBlock { Install-distChrome }
Start-Job -ScriptBlock { Install-distEdge }
Start-Job -ScriptBlock { Install-distVSCode }
Start-Job -ScriptBlock { Install-distGIT }
